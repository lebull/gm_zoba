...
hook.Add("SetupMove", "zoba.camera.calcSetupMove", setupMove)
...
elseif SERVER then
	...
	hook.Add("PlayerSpawn", "zoba.camera.playerSpawn", playerSpawn)
	...
	hook.Add("PlayerDeath", "zoba.camera.playerDeath", playerDeath)
